<template>
  <div class="box">
    <h4>
        <el-button type="info" @click = 'saveLayout'>保存</el-button>
        <el-button type="success" @click = 'getLayout'>映射</el-button>
    </h4>
    <el-row :gutter="10">
      <el-col :span="8">
      ...
      <el-col :span="8" class="flxed">
        <!--视图区-->
        <div class="grid-content" id="box" @dragstart='removedrop($event)' @drop='copydrap($event)' @dragover='allowDrop($event)' ref = 'box'></div>
        <!--移除区-->
      ...
      <el-col :span="8" class="flxed">
        <!--查看源码-->
        <div class="grid-content bg-purple-light" id="codeBox" ref='codeBox'></div>
      </el-col>
    </el-row>
    <!--模态框-->
  ...
  methods: {
    ...
    updateLabel: function() {
      ...
      document.getElementById(
        this.labelid
      ).children[0].children[0].innerHTML = this.labelname;
    },
    ...
    saveLayout () {
        this.codeDatas = this.$refs.box.innerHTML;
    },
    getLayout () {
        this.$refs.codeBox.innerHTML = this.codeDatas;
    }
  }
};
</script>
...
#removeBox {
  ...
  bottom: 10px;
  right: 20px;
  background: url(/static/deleteBox.png) no-repeat;
